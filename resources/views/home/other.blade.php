...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('jquery.timepicker.css') }}">
...
<nav class="navbar py-4 navbar-expand-lg ftco_navbar navbar-light bg-light flex-row">
    <div class="container">
        <div class="row no-gutters d-flex align-items-start align-items-center px-3 px-md-0">
            <div class="col-lg-9 col-md-9 pr-4 align-items-center">
                <a class="navbar-brand" href="/index">UBER<span>AMBULANCE</span></a>
            </div>


            <div class="col-md-3 pr-3 d-flex topper align-items-center">
                <div class="icon bg-white mr-2 d-flex justify-content-center align-items-center"><span class="icon-timer"></span></div>
                <span class="text"> 24H/24 - 7J/7</span>
            </div>


            <div class="col-lg-10 col-sm-3 d-none d-md-block">
                <div class="row d-flex">
                    <div class="col-md-4 col-sm-4 pr-4 d-flex topper align-items-center">
                        <div class="icon bg-white mr-2 d-flex justify-content-center align-items-center"><span class="icon-map"></span></div>
                        <span class="text">Address: 198 West 21th Street, Suite 721 New York NY 10016</span>
                    </div>
                    <div class="col-md-4 col-sm-4 pr-4 d-flex topper align-items-center">
                        <div class="icon bg-white mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
                        <span class="text">Email: contact@uberambulance.com</span>
                    </div>
                    <div class="col-md-4 col-sm-4 pr-4 d-flex topper align-items-center">
                        <div class="icon bg-white mr-2 d-flex justify-content-center align-items-center"><span class="icon-phone2"></span></div>
                        <span class="text">Phone: +237 652 568 589</span>
                    </div>
                </div>
            </div>
        </div>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-white ftco-navbar-light justify-content-between navbar-right" id="ftco-navbar">
    <div class="container d-flex align-items-center">
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
            <span class="oi oi-menu"></span> Menu
        </button>
        <p class="button-custom order-lg-last mb-0 "><a href="appointment.html" class="btn btn-secondary ">Prendre un Rendez - Vous</a></p>
        <p class="button-custom order-lg-last mb-0 ">&nbsp;&nbsp;<a href="appointment.html" class="btn btn-secondary ">Commander Une Ambulance</a></p>
...
<section class="ftco-section ftco-no-pt ftc-no-pb">
    <div class="container">
        <div class="row no-gutters">
            <div class="col-md-5 p-md-5 img img-2 mt-5 mt-md-0" style="background-image: url({{ asset('/images/about.jpg') }});">
            </div>
            ...
            <div class="row">
                <div class="col-md-12 nav-link-wrap">
                    <div class="nav nav-pills d-flex text-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link ftco-animate active" id="v-pills-1-tab" data-toggle="pill" href="#v-pills-1" role="tab" aria-controls="v-pills-1" aria-selected="true">AMBULANCES</a>

                        <a class="nav-link ftco-animate" id="v-pills-2-tab" data-toggle="pill" href="#v-pills-2" role="tab" aria-controls="v-pills-2" aria-selected="false">MEDECINS</a>

                        <a class="nav-link ftco-animate" id="v-pills-3-tab" data-toggle="pill" href="#v-pills-3" role="tab" aria-controls="v-pills-3" aria-selected="false">ASSISTANCE CHAT</a>
                ...
                <div class="col-md-12 tab-wrap">
                    ...
                    <div class="tab-content bg-light p-4 p-md-5 ftco-animate" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-day-3-tab">
                            <div class="row departments">
                                <div class="col-lg-4 order-lg-last d-flex align-items-stretch">
                                    <div class="img d-flex align-self-stretch" style="background-image: url({{ asset('/images/dept-3.jpg') }});"></div>
                                </div>
                                <div class="col-md-8">
                        ...
                        <div class="tab-pane fade" id="v-pills-4" role="tabpanel" aria-labelledby="v-pills-day-4-tab">
                            <div class="row departments">
                                <div class="col-lg-4 order-lg-last d-flex align-items-stretch">
                                    <div class="img d-flex align-self-stretch" style="background-image: url({{ asset('/images/dept-4.jpg') }});"></div>
                                </div>
                                <div class="col-md-8">
...
<section class="ftco-section ftco-no-pt ftco-no-pb ftco-counter img" id="section-counter" style="background-image: url({{ asset('/images/bg_3.jpg') }});" data-stellar-background-ratio="0.5">
    <div class="container">
        <div class="row">
...
<footer class="ftco-footer ftco-bg ftco-section">
    <div class="container">
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-5">
                    <h2 class="navbar-brand">UBER<span>AMBULANCE</span></h2>
                    <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                </div>
                <div class="ftco-footer-widget mb-5">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            ...
                            <li><a href="#"><span class="icon icon-envelope"></span><span class="text">contact@uberambulance.com</span></a></li>
                        </ul>
                    </div>
            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-5">
                    <h2 class="ftco-heading-2">Heures de Service</h2>
                        <h3 class="open-hours pl-4"><span class="icon-timer"></span>Nous Sommes disponibles 24H/24 , 7J/7</h3>
                </div>
                <div class="ftco-footer-widget mb-5">
